...
def dibujar_boton_top(ventana: int, fuente: str, evento: list, estado: list):
    """Funcion que dibuja el boton de "los top puntajes".

    Args:
        ventana: int: Numerico, fuente: str: String,  evento: list: Lista, estado: list: Lista.
    """
    x = 50
    y = 50
    boton_altura = 50
...
def dibujar_top_5(pantalla: int, lista_top: list, fuente: str):
    """Donde se dibujan los cambios.

    Args:
        pantalla: int: Numerico, lista_top: list: Lista, fuente: str: String.
    """
...
def top_cinco(ventana: int, fuente: str, lista_jugadores: list):
    """Aplicamos todas las funciones para el muestreo.

    Args:
        ventana: int: Numerico, fuente: str: String lista_jugadores: list: Lista.
    """
