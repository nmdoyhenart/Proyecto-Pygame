...
def tiempo(ventana: int, FUENTE: str, contador: int, limite_tiempo: int, fps: int):
    """Grafico para mostrar el contador.

    Args:
        ventana: int: Numerico, FUENTE: str: String, contador: int: Numerico, limite_tiempo: int: Numerico, fps: int: Numerico.
    """
    time_x = 5
    time_y = 5
    time_ancho = 40
