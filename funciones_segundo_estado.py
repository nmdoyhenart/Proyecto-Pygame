...
def arranque_juego(FUENTE: str, ventana, evento: list, pregunta_aleatoria: list):
    """Función que da comienzo al juego

    Args:
        FUENTE: str: String, ventana: surface: Superficie, evento: list: Lista, pregunta_aleatoria: list: Lista
    """
...
def boton_rojo_y_boton_azul(FUENTE: str, ventana, opcion_roja: int, opcion_azul: int):
    """Función que crea ambos botones

    Args:
        FUENTE: str: String, ventana: surface: superficie, opcion_roja: int: Numerico, opcion_azul: int: Numerico.
    """   
    x = 100
    y = 600
    boton_altura = 90
...
def texto_pregunta(pregunta: str, ventana, FUENTE: str):
    """Grafica para las preguntas.

    Args:
        pregunta: str: String, ventana: surface: superficie, FUENTE: str, String.
    """
    ancho = 500
    alto = 50
    x = 100
...
def decision_personaje(ventana, estado: bool, color: str):
    ...
    Args:
        ventana: surface: Superficie, estado: bool: Devuelve True o False, color: str: String.
    """
    if estado:
...
def comodines(ventana, comodin_uno: bool, comodin_dos: bool, comodin_tres: bool, evento: list, estado: list):
    """Comprueba si el título existe y lo elimina de la lista.

    Args:
        ventana: surface: Superficie, comodin_uno: Bandera, comodin_dos: Bandera, comodin_tres: Bandera, evento: list: Lista, estado: list: Lista.
    """
    x_comodines = 10
    y_caja = 500
    ancho_comodin = 30
...
def logica_comodines(ventana, comodin_uno: bool, comodin_dos: bool, comodin_tres: bool, estado: list, back_comodines: int, preguntas: list, pregunta_aleatoria: str, habilitar_comodin_tres: bool, contador_tiempo: int):
    """Grafica los botones para accionar los comodines.

    Args:
        ventana: surface: Superficie, comodin_uno: Bandera, comodin_dos: Bandera, comodin_tres: Bandera, evento: estado: list: Lista, back_comodines: int: Numerico, preguntas: list: Lista, pregunta_aleatoria: str: String, habilitar_comodin_tres: bool: Booleando, contador_tiempo: int: Numerico.
    """       
