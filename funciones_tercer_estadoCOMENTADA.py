...
def funcion_comodin_tres(ventana: int, lista_jueces: list, comodin_tres: bool, contador_tiempo: int):
    """Lo relacionado con el tercer estado.

   Args:
        ventana: int: Numerico, lista_jueces: list: Lista, comodin_tres: bool: Bandera, contador_tiempo: int: Numerico.
    """
    tribuna(ventana)
    jueces_funcion(ventana, lista_jueces, comodin_tres, contador_tiempo)

def ganar_perder(ventana: int, fuente: str, comprobar_eleccion, habilitar_sonido):
    """Lo relacionado con el tercer estado.

   Args:
        ventana: int: Numerico, fuente: str: String, comprobar_eleccion, habilitar_sonido
    """
...
def jueces_funcion(ventana: int, lista_jueces: list[tuple], comodin_tres: bool, contador_tiempo: int):
    """Muestra la votación de los jueces, rojo o azul.

    Args:
        ventana: int: Numerico, lista_jueces: list[tuple]: Lista que devuelve tupla, comodin_tres: bool: Bandera, contador_tiempo: int: Numerico.
    """
    decision_x = 40
    decision_y = 40
    coordenada_x = 100
...
def cuadro_porcentaje(ventana: int, fuente_porcentaje: str, decision: list):
    """Grafica el porcentaje de la decision de los jueces.

    Args:
        ventana: int: Numerico, fuente_porcentaje: str: String, decision: list: Lista.
    """
