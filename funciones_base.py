...
def dibujar_boton_rectangulo(ventana, tupla_dimensiones: tuple, fuente: str, texto_boton: str, color_boton: str):
    """Funcion que dibuja y muestra el boton.

    Args:
        ventana: surface: Superficie, tupla_dimensiones: tuple: Tupla, fuente: str: String, texto_boton: str: Stirng, color_boton: str: String.
    """
